    ...
    >
      <Box>
        <ListItem
          ...
          sx={{ justifyContent: 'initial', marginTop: '20px', paddingLeft: collapsed ? '0.5rem' : '1rem' }}
        >
          <Tooltip title={collapsed ? 'Dashboard' : ''} placement="right">
            <Link href="/dashboard" passHref>
              <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                <ListItemIcon sx={{ minWidth: '40px' }}> {/* Ensure equal left space */}
                  <HomeIcon />
                </ListItemIcon>
        ...
        <List>
          <ListItem
            ...
            sx={{ justifyContent: 'initial', paddingLeft: collapsed ? '0.5rem' : '1rem' }}
          >
